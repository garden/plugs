/* webjson.js: Display JSON data with editable HTML elements.
 * Copyright (c) 2010-2012 Thaddee Tyl, Jan Keromnes. All rights reserved.
 */
...
JSON._plates.rewrite = {
  'css': function(id) {
    return 'div.webjson-element {' +
             'margin-left: 0.5em;' +
           '}' +
           'div.webjson-element > button.close {' +
             'border: 0;' +
             ...
             'visibility: hidden;' +
           '}' +
           'div.webjson-element:hover > button.close {' +
             'visibility: visible;' +
           '}' +
           'div.webjson-element:hover > button.close:hover {' +
             'color: black;' +
           '}' +
           'input.webjson-edit {' +
             'box-shadow: 0px 0px 3px orange inset;' +
             'border: 0px;' +
           '}';
  },
  'objkey': function(path, id, key) {
    /* Remove: 1. Data; 2. Graphics. */
    return '<button class="close" onclick="delete JSON.getweb[\'' + id + '\']' +
        path + '[\''+key+'\']; ' +
  ...
  'obj': function(obj, path, id, template) {
    ...
    var i;
    for (i in obj) {
      html += '<div class="webjson-element">' + JSON._plates.rewrite.objkey(path, id, i) +
  ...
  'str': function(obj, path, id) {
    // ROCK'N'ROLL
    return "<span ondblclick=\"this.innerHTML=&quot;&lt;input class=&#92;&quot;webjson-edit&#92;&quot; value=&#92;&quot;" +
      obj + "&#92;&quot; onblur=&#92;&quot;this.outerHTML=this.value&#92;&quot; oninput=&#92;&quot;JSON.getweb['" + id + "']" +
      path + "=this.value;&#92;&quot;&gt;&quot;; this.firstChild.focus();\">" +
      obj + "</span>";
  },
  ...
  'addObjBut': function(button, path, id, key) {
    ...
    div.innerHTML = JSON._plates.rewrite.addButAsk(path, id, key,
      function(path, id, key) {
        return '' +
         /* Graphical update */
         'var parent = that.parentNode;' +
         'parent.innerHTML = JSON._plates.rewrite.objkey(&quot;' + path +
           '&quot;, &quot;' + id +'&quot;, &quot;' + key + '&quot;) + ' +
