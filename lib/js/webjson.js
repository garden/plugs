...
// Copyright © 2010-2013 Thaddee Tyl, Jan Keromnes. All rights reserved.
(function() {
...
JSON._plates.rewrite = {
  ...
  objkey: function(path, id, key) {
    ...
    return '<button class="delete" onclick="delete JSON.getweb[' +
      ...
      'this.parentNode.parentNode.removeChild(this.parentNode)">&times;</button>' +
  ...
  obj: function(obj, path, id, template) {
    ...
    var html = '';
    html += '<button class="delete hidden">&times;</button>{';
    var i;
    for (i in obj) {
    ...
    html += '<div class="webjson-element">' +
      /* Value. */
      '<button class="delete hidden">&times;</button>' +
      /* add button. */
      '<button class="shown" onclick="JSON._plates.rewrite.addObjBut(this,&quot;' +
      path + '&quot;,\'' +
  ...
  addButAsk: function(path, id, update) {
    return '<span><select class="shown">' +
     ...
     '<button class="shown" onclick="(function(that){' +
       'var o;' +
